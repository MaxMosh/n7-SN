...
<!-- TODO : malheureusement, j'ai pas pu mettre en commun parce que mon RStudio réussissait pas à ouvrir le fichier .csv
Dans un monde à peut près idéal, remplacer le bout de code R suivant par un Data_mlg = Data_log devrait suffir. 
-->
```{r, echo=F, eval=F}
library(bestglm)
...
<!-- TODO : normaliser la notation des variables (choisir entre $$ ou \code{}) -->

<!-- TODO : passer en echo = T (sûrement) -->
```{r, echo=T, eval=T}
...
<!-- TODO : je sais pas si on peut apporter plus de choses à cette remarque -->
