...
NB is the number of block-columns the matrix is made of.\n");
  ...
  for(i=1; i <=maxloop; i*=2){
    ...
    /* printf("||Ax-b||     : %.4e\n",check_res(A, Acpy)); */
    printf("%7.1f,   %7.1f,   ",(t_end-t_start)/1e3,flops/(t_end-t_start)/1e3/((double)nth));
    fprintf(fptr, "%7.1f,   %7.1f,   ",(t_end-t_start)/1e3,flops/(t_end-t_start)/1e3/((double)nth));
    ...
    /* printf("Gflop/s      : %7.1f\n",flops/(t_end-t_start)/1e3); */
    /* printf("||Ax-b||     : %.4e\n",check_res(A, Acpy)); */
    printf("%7.1f,   %7.1f\n",(t_end-t_start)/1e3,flops/(t_end-t_start)/1e3/((double)nth));
